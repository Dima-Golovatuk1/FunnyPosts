        ...
        <footer className="footer">
            <div className="container">
                ...
                <div className="footer__info">
                    <h2 className="footer__info__title">Information about the company</h2>
                    <ul className="footer__info__list">
                        <li className="footer__info__item">
                            <a className="footer__info__item__link" href="">about us</a>
                        </li>
                        <li className="footer__info__item">
                            <a className="footer__info__item__link" href="">Terms of use of the site</a>
                        </li>
                        <li className="footer__info__item">
                            <a className="footer__info__item__link" href="">Vacancies</a>
                        </li>
                        <li className="footer__info__item">
                            <a className="footer__info__item__link" href="">Contacts</a>
                        </li>
                    </ul>
                </div>
            </div>
